...
- 각 감정 기준:
  - 무기력: 아무것도 하고 싶지 않고 의욕 자체가 없을 때. 뭔가를 이루고 싶거나 걱정되는 게 있다면 무기력이 아님. 번아웃, 지침, 공허함은 불안이나 슬픔에 더 가까울 수 있음.
  - 불안: 앞으로 일어날 일에 대한 걱정, 불확실함. 잘 될지 모르는 느낌, 개발/취업/미래에 대한 고민.
  - 슬픔: 이미 일어난 일에 대한 상실감, 아쉬움.
  - 분노: 부당함, 억울함, 짜증.
  - 외로움: 연결되고 싶은데 안 되는 느낌.
  - 두려움: 특정 상황이나 결과에 대한 공포.
  - 평온: 안정적이고 잔잔한 상태.
  - 설렘: 기대감, 두근거림.
  - 기쁨: 즐거움, 신남.
  - 감사: 고마운 마음.
