...
const STANDARD_EMOTIONS = ['불안/걱정', '지침/번아웃', '분노/억울', '슬픔/상실', '외로움', '두려움', '기쁨/설렘', '감사/평온', '복합/일상']
...
반환 형식:
{
  "emotion": "아래 9개 중 하나만 정확히 반환. 이 외 단어 절대 사용 금지: 불안/걱정, 지침/번아웃, 분노/억울, 슬픔/상실, 외로움, 두려움, 기쁨/설렘, 감사/평온, 복합/일상",
...
규칙:
- emotion은 반드시 위 9개 중 하나. 절대 다른 단어 사용 금지.
- 각 감정 기준:
  - 불안/걱정: 앞으로 일어날 일에 대한 걱정, 불확실함. 잘 될지 모르는 느낌, 개발/취업/미래에 대한 고민.
  - 지침/번아웃: 더 이상 하고 싶지 않고 계속할 의욕이 완전히 소진된 상태. 힘들어도 계속하고 싶은 마음이 있다면 지침/번아웃이 아님.
  - 분노/억울: 부당함, 억울함, 짜증.
  - 슬픔/상실: 이미 일어난 일에 대한 상실감, 아쉬움.
  - 외로움: 연결되고 싶은데 안 되는 느낌.
  - 두려움: 특정 상황이나 결과에 대한 공포. 두려움 때문에 아무것도 못 하는 느낌.
  - 기쁨/설렘: 즐거움, 신남, 기대감, 두근거림.
  - 감사/평온: 고마운 마음, 안정적이고 잔잔한 상태.
  - 복합/일상: 딱 잘라 분류하기 어려운 일상적인 감정. 여러 감정이 섞여있거나 감정이 뚜렷하지 않을 때.
- 가장 핵심적인 감정 하나만 선택. 복합 감정이면 더 강한 쪽으로. 애매하면 복합/일상으로.
